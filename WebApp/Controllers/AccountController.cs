...
public class AccountController(UserManager<UserEntity> userManager, ApplicationContext context) : Controller
{
    ...
    public async Task<IActionResult> Details()
    {
        ...
        var viewModel = new AccountDetailsViewModel
        {
            ...
            {
                AddressLine_1 = user.Address?.AdressLine_1!,
                AddressLine_2 = user.Address?.AdressLine_2!,
        ...
        if (TryValidateModel(model.Address!))
        {
            ...
            if (user != null)
            {
                try
                {
                    ...
                    {
                        user.Address.AdressLine_1 = model.Address!.AddressLine_1;
                        user.Address.AdressLine_2 = model.Address!.AddressLine_2;
